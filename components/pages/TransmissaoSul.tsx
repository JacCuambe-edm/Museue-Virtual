...
const TransmissaoSul: React.FC = () => {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState<'Substacao' | 'Linha'>('Substacao');
          ...
          <div className="bg-white rounded-lg shadow-2xl p-8 md:p-10">
            <div className="border-l-4 border-brand-orange pl-6">
              ...
              <p className="text-gray-600 leading-relaxed text-left md:text-justify">
                Conheça as subestações e linhas de transmissão que compõem a rede de transporte de energia da região Sul de Moçambique.
              </p>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="relative bg-white rounded-3xl overflow-hidden border border-gray-100 group-hover:border-transparent transition-colors duration-500">
                    ...
                    <div className="p-6 relative">
                      ...
                      {/* Category Tag */}
                      <span className="text-xs font-medium text-brand-orange mb-4 block">Transmissão Sul</span>
