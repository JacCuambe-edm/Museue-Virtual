...
import { ChevronRight, Receipt, Calculator, CreditCard, ArrowRight } from 'lucide-react';
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        // Include both 'Comercial' and 'Comercialização'
        setArtifacts(all.filter((a: any) =>
          a.area_negocio === 'Comercial' || a.area_negocio === 'Comercialização'
        ));
      } catch (err) {
          ...
          <div className="bg-brand-orange rounded-lg shadow-2xl p-8 md:p-10">
            <div className="border-l-4 border-white pl-6">
              ...
              <p className="text-white/90 leading-relaxed text-left md:text-justify">
                Explore a história comercial da EDM através de documentos, equipamentos e sistemas que marcaram a relação
                com os clientes. Faturas históricas, máquinas registradoras e uniformes que contam a evolução do
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-8 text-left md:text-justify">
                Os artefatos comerciais preservam a memória da interação entre a EDM e seus clientes ao longo das décadas.
                Desde os primeiros livros de registro até os modernos sistemas de atendimento, cada item documenta a evolução
                dos serviços prestados à população moçambicana.
              </p>
              <Link
                to="/artefatos"
