...
const PatrimonioGeracao: React.FC = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await api.getPatrimonios({ area_negocio: 'Geração' });
        setItems(data);
      } catch (error) {
          ...
          <div className="bg-white rounded-lg shadow-2xl p-8 md:p-10">
            <div className="border-l-4 border-brand-orange pl-6">
              ...
              <p className="text-gray-600 leading-relaxed text-left md:text-justify">
                Conheça as centrais de geração de energia que fazem parte do patrimônio histórico da EDM. Estruturas que marcaram o desenvolvimento energético de Moçambique ao longo das décadas.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="relative bg-white rounded-3xl overflow-hidden border border-gray-100 group-hover:border-transparent transition-colors duration-500">
                    ...
                    <div className="relative h-52 overflow-hidden">
                      <img 
                        ...
                        onError={(e) => {
                          e.currentTarget.src = 'https://via.placeholder.com/400x250/f97316/ffffff?text=EDM+Geração';
                        }}
                      />
                    ...
                    <div className="p-6 relative">
                      ...
                      {/* Category Tag */}
                      <span className="text-xs font-medium text-brand-orange mb-4 block">Geração</span>
...
export default PatrimonioGeracao;
