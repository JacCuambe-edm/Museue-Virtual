...
const PatrimonioTransporte: React.FC = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await api.getPatrimonios({ area_negocio: 'Transporte' });
        setItems(data);
      } catch (error) {
          ...
          <div className="bg-white rounded-lg shadow-2xl p-8 md:p-10">
            <div className="border-l-4 border-brand-orange pl-6">
              ...
              <p className="text-gray-600 leading-relaxed text-left md:text-justify">
                Explore as linhas de transmissão e subestações que compõem a infraestrutura de transporte de energia da EDM. Estruturas vitais que conectam todo o território de Moçambique.
              </p>
            </div>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center text-center py-20">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
                Nenhum item foi publicado
              </h2>
              <p className="text-gray-500 max-w-md">
                Ainda não existem itens publicados nesta secção. Volte em breve para conferir as novidades.
              </p>
            </div>
          ) : (
                  ...
                  <div className="relative bg-white rounded-3xl overflow-hidden border border-gray-100 group-hover:border-transparent transition-colors duration-500">
                    ...
                    <div className="p-6 relative">
                      ...
                      <p className="text-gray-500 text-sm mb-4 line-clamp-2 leading-relaxed">
                        {item.sigla || item.tipo}
                      </p>
                      
                      {/* Category Tag */}
                      <span className="text-xs font-medium text-brand-orange mb-4 block">Transporte</span>
...
export default PatrimonioTransporte;
